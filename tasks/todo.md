...
## Commit and push public-first polish

- [x] Review the working tree and identify project files vs local-only files
- [x] Verify the lightweight/public-first changes still pass validation
...
- README now presents `md-anything` as a professional, local-first product
